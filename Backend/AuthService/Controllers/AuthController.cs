...
[HttpGet("classify/all")]
public async Task<IActionResult> GetAllClassifiedUsers()
{
    var users = await _userService.GetAllClassifiedUsersAsync();

    if (users == null || users.Count == 0)
        return NotFound("No classified users found.");
